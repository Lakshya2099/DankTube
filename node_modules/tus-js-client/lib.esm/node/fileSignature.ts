 ...
 */
export default function fingerprint(file: any, options: any) {
  ...
  if (file instanceof fs.ReadStream && file.path != null) {
    return new Promise(function (resolve, reject) {
      // @ts-expect-error TS(2345): Argument of type 'string | Buffer' is not assignab... Remove this comment to see the full error message
