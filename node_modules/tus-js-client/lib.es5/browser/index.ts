...
var _window = window,
  // @ts-expect-error TS(7022): 'XMLHttpRequest' implicitly has type 'any' because... Remove this comment to see the full error message
  XMLHttpRequest = _window.XMLHttpRequest,
  // @ts-expect-error TS(7022): 'Blob' implicitly has type 'any' because it does n... Remove this comment to see the full error message
  Blob = _window.Blob;
